          ...
          <div>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700 ml-5">                  
              <li className="text-left justify-left mb-10 ml-6">        
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">I am extremely familiar with javascript, and have used it for most of my programming projects, due to them mostly being web based. I have coded completely from scratch, as well as utilizing libraries, like passport.js, and three.js.</p>
              </li>
            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700 ml-5">                  
              ...
              <li className="text-left justify-left mb-10 ml-6"> 
                <div className="absolute w-4 h-4 rounded-full mt-1.5 -start-2 border border-white dark:border-gray-900 bg-highlight"></div>                
                <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">• Videography</h3>
