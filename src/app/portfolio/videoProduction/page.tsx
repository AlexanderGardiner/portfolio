        ...
        <ol className="w-full relative border-l border-gray-200 dark:border-gray-700">                  
            ...
            <li className="mb-10 ml-6">            
                ...
                <div className="flex items-center my-4">
                    <div className="pr-6">
                        <FaCamera className="scale-150" style={{color: "#6a84f4"}} size={30}/> 
                    </div>
                    <div className="pr-6">
                        <FaCut className="scale-150" style={{color: "#6a84f4"}} size={30}/>   
                    </div>
                    <div className="pr-6">
                        <FaVolumeUp className="scale-150" style={{color: "#6a84f4"}} size={30}/>   
                    </div>
                </div>
                ...
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1Zw4oFfKx9G8pl38uP-YDsZ9VpPTU0X-n/preview"></iframe>

            </li>
            <li className="mb-10 ml-6">    
                <div className="absolute w-4 h-4 rounded-full mt-1.5 -start-2 border border-white dark:border-gray-900 bg-highlight"></div>        
                <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">STN 60 second Horrorfest Contest</h3>
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">2023</time>
                <div className="flex items-center my-4">
                    <div className="pr-6">
                        <FaCamera className="scale-150" style={{color: "#6a84f4"}} size={30}/> 
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">A 60 second horror short film created for the STN Horrorfest Contest <a className="text-highlight hover:text-white" href="https://studenttelevision.com/sixty-second-horrorfest/">https://studenttelevision.com/sixty-second-horrorfest/</a>. This project was filmed and edited in around 2 weeks during High School. I was one of the primary cameramen and the primary editor. We had to include the line of dialogue &quot;Is it over?&quot;, a video from a horror film in the public domain, as well as a mirror.</p>
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1HniKviLjajNwXm2XqhAtv3mrxMfaJ88U/preview"></iframe>
            ...
            <li className="mb-10 ml-6"> 
                ...
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1HeJkS-l8p1N0-SNmgoHU8LZpGGrExxr6/preview"></iframe>
            ...
            <li className="mb-10 ml-6">  
                ...
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/15lLGzYhTUnhUlz-ggwVZ8_mxInMV3c1t/preview"></iframe>
            ...
            <li className="mb-10 ml-6">   
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">A short intro created for the high school news program at my school. This intro played on the daily news show during 2023. It showcases life at my high school as well as the news program itself. <a className="text-highlight hover:text-white" href="https://dpnews.org/">https://dpnews.org/</a></p>
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1RGpNQnXHQ61EV5G48e1iSNhtzhnlIC1Z/preview"></iframe>
            ...
            <li className="mb-10 ml-6">    
                ...
                <div className="flex items-center my-4">
                    ...
                    <div className="pr-6">
                        <FaUser className="scale-150" style={{color: "#6a84f4"}} size={30}/>   
                    </div>
                </div>
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">A 30 second PSA created for the Santa Barbara Waterwise video contest. WaterwiseSB is a regional partnership that aims to promote water use efficiency <a className="text-highlight hover:text-white" href="https://waterwisesb.com/">https://waterwisesb.com/</a>. I entered this yearly video contest and was the actor, as well as one of the editors for the project.</p>
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1Q2zk6W6fZOlZEi68dEPN_nlRurtS5hZI/preview"></iframe>
            ...
            <li className="mb-10 ml-6">  
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">A 60 second horror short film created for the STN Horrorfest Contest <a className="text-highlight hover:text-white" href="https://studenttelevision.com/sixty-second-horrorfest/">https://studenttelevision.com/sixty-second-horrorfest/</a>. This was filmed in around 2 hours. I was one of the primary editors, as well as the primary videographer. We had to include a box (the elevator was our box of choice), a line (&quot;Don&apos;t be scared, just come with me&quot;), and negative space.</p>
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1sZHb3PolZdA1NPtRehYvuIupLM2aEgDM/preview"></iframe>
            ...
            <li className="mb-10 ml-6"> 
                ...
                <iframe className="w-full aspect-video" allowFullScreen src="https://drive.google.com/file/d/1r0tJbvFHotFWlEfNwEYAwpry3s0akEIE/preview"></iframe>
