      ...
      <div className="flex items-center justify-center py-5 max-w-2xl">
        <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
            ...
            <li className="mb-10 ml-6">            
                ...
                <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">A 30 second commerical created for the STN Challenge Contest. This project was filmed in around 2 hours and edited in around a day during High School. I was the primary cameramen and the ... editor.</p>
