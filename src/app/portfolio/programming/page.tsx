        ...
        <ol className="w-full relative border-l border-gray-200 dark:border-gray-700">
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              ...
              <li>
                Benchmarked and optimized neural networks, logistic regression,
                XGBoost, and transformer models to identify the best-performing
                approaches.
              </li>
            </ul>
          ...
          <li className="mb-10 ml-6">
            ...
            <details className="mb-4" open>
              ...
              <ul className="list-disc list-inside text-gray-500 dark:text-gray-400 mt-2">
                <li>
                  Developed advanced PID motor control with improved
                  responsiveness for precise robot movements.
                </li>
                <li>
                  Enhanced AprilTag vision system for tag-specific localization,
                  increasing positioning accuracy in complex scenarios.
                </li>
                <li>
                  Integrated assisted operation features for automatic scoring
            ...
            <details className="mb-4">
              ...
              <ul className="list-disc list-inside text-gray-500 dark:text-gray-400 mt-2">
                ...
                <li>
                  ...
                  localization within 10cm at distances up to 5 meters.
                </li>
                <li>
                  Transitioned to a community-created swerve library to ensure
                  maintainability and allow new team members to contribute
                  effectively.
                </li>
                <li>
            ...
            <details className="mb-4">
              ...
              <ul className="list-disc list-inside text-gray-500 dark:text-gray-400 mt-2">
                ...
                <li>
                  ...
                  for AprilTags for basic autonomous navigation.
                </li>
                <li>
                  Implemented autonomous pathing achieving a competitive auto
                  routine.
                </li>
                <li>
                  Built modular software infrastructure to allow future students
                  to maintain and expand functionality.
                </li>
                <li>
                  Won the Rookie All Star Award and qualified for World
                  Championships
                </li>
              </ul>
              <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Enhanced a public dataset using impulse response convolution to
                simulate diverse recording environments and improve model
                generalization.
              </li>
              <li>
                Developed multiple AI models with TensorFlow to classify music
                genres in real-world contexts, achieving a 34% accuracy
                improvement over the raw dataset.
              </li>
            </ul>
          </li>
          <li className="mb-10 ml-6">
            ...
            <div className="flex flex-wrap items-center my-4">
              ...
              <h5 className="text-lg mr-3 mb-2 text-highlight font-bold">
                Tailwind CSS
              </h5>
              <h5 className="text-lg mr-3 mb-2 text-highlight font-bold">
                Daisy UI
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a privacy-focused web app that allows users to take a
                picture of ingredients and generate personalized recipes using
                in-browser YOLO for object detection, sending only detected
                ingredients to ChatGPT.
              </li>
              <li>
                Removed the need for external recipe APIs while producing
                high-quality recipe suggestions.
              </li>
              <li>
                Integrated secure Google OAuth authentication and stored user
                recipes in MongoDB.
              </li>
              <li>
                Enabled social features including recipe sharing, commenting,
                and feedback forums.
              </li>
              <li>
                Implemented privacy controls and shareable recipe links for
                public or private recipes.
              </li>
              <li>
                Delivered a full-stack AI-powered solution combining computer
                vision, LLMs, and interactive web technologies.
              </li>
            </ul>
            <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a modular scouting web application for FRC Team 9084,
                designed to adapt to any game, improving data collection,
                organization, and real-time match analysis.
              </li>
              <li>
                Created dynamic, interactive data visualizations using CanvasJS,
                enabling the team to identify trends, optimize strategy, and
                make evidence-based decisions during competitions.
              </li>
              <li>
                Established and led a scouting team in 2025 to maintain, expand,
                and iterate on the web app, ensuring it remains actively used
                and continually improved.
              </li>
              <li>
                Added features such as customizable reports, team comparisons,
                and performance trend tracking, making the app a critical tool
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a fully online video editor using Next.js, Tailwind
                CSS, and FFmpeg.
              </li>
              <li>
                Implemented features including cutting clips, setting in/out
                points, audio support, video resizing, and rotation.
              </li>
              <li>
                Enabled project saving, loading, and exporting at full quality,
                providing a complete end-to-end video editing workflow in the
                browser.
              </li>
            </ul>
            <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a simplified simulation of slime mold behavior using
                HTML, CSS, and JavaScript.
              </li>
              <li>
                Optimized the simulation to efficiently run in the browser,
                handling up to around a million mold particles.
              </li>
              <li>
                Inspired by{" "}
                <a
          ...
          <li className="mb-10 ml-6 mt-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a custom library for FRC Team 9084, including swerve
                drive code with odometry and pose estimation.
              </li>
              <li>
                Implemented utility classes for motor initialization, as well as
                math and gyro operations, simplifying robot code development.
              </li>
              <li>
                Designed the library to improve maintainability, reusability,
                and overall performance of the team&apos;s robot software.
              </li>
            </ul>
            <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a customizable web-based project management program
                with an HTML, JS, and CSS frontend and Node.js (Express)
                backend.
              </li>
              <li>
                Implemented user authentication with Passport and data storage
                using MongoDB.
              </li>
              <li>
                Enabled features including custom projects, file uploads, and
                user management for collaborative project tracking.
              </li>
            </ul>
            <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a customizable web-based scouting system for FRC Team
                9084 for the 2023 &quot;Charged Up&quot; competition.
              </li>
              <li>
                Built a web user interface for inputting match data, which is
                uploaded to a server for collection.
              </li>
              <li>
                Stored data as CSV files to enable easy analysis and support
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a particle simulation as an AP Physics final project
                using HTML Canvas, JavaScript, and CSS.
              </li>
              <li>
                Implemented programmable particle charges and sizes, simulating
                electric and magnetic fields.
              </li>
              <li>
                Built the simulation from scratch, demonstrating fundamental
                physics principles interactively in the browser.
              </li>
            </ul>
            <a
          ...
          <li className="mb-10 ml-6">
            ...
            <ul className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400 list-disc list-inside">
              <li>
                Developed a platformer game from scratch using HTML Canvas,
                JavaScript, and CSS.
              </li>
              <li>
                Implemented level loading and tracking of player times, with
                data uploaded to a server for competition among friends.
              </li>
              <li>
                Created an engaging game that was widely played and fostered
                friendly competition for fastest times.
              </li>
            </ul>
            <a
